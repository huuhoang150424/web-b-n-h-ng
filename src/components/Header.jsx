    ...
    return (
        <header className="w-full gap-[50px] h-auto wrapper flex items-center justify-between bg-primaryColor py-[6px] z-30 sticky top-0 shadow-md ">
            ...
            <div className="w-[30%] flex items-center gap-[10px] ">
                ...
                {!user?.isAdmin && <Line className="h-[25px] w-[1px] " />}
                <div className={`flex items-center ${user?.isAdmin && "ml-[200px]"}` }>
                                ...
                                </li>
                                {
                                    user?.isAdmin && (
                                        <li className="py-[10px] cursor-pointer" >
                                            <Link to={'/system/admin'} onClick={() => setHiddenModelUser(false)} className="flex justify-center text-[1.2rem] font-[400] ">Quản lý hệ thống</Link>
                                        </li>
                                    )
                                }
                            </ul>
